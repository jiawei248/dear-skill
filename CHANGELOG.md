...
First public release of `gift-everyday` as a relationship-aware gift skill for Hermes-style agents.

### Added

- a complete five-stage gift pipeline: editorial judgment, synthesis, creative concept, visual strategy, and final rendering
- four practical output formats: `h5`, `image`, `text`, and bounded `text-play`, plus `hybrid` mode for format selection by fit
